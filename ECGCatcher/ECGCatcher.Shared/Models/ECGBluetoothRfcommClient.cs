...
namespace BluetoothRfcommClientWP8
{
    public class ECGBluetoothRfcommClient : IBluetoothClient
    {
        ...
        public ECGBluetoothRfcommClient(Guid bluetoothServiceUuid, string bluetoothDisplayDisplayName, bool AutoStart = false)
        {
        ...
        public async Task<List<BluetoothDevice>> GetListPairedDevices()
        {
            ...
            if (peers.Count != 0)
            {
                foreach (var peer in peers)
                {
                    ...
                    list.Add(new BluetoothDevice(peer.DisplayName, peer.DisplayName, peer.DisplayName));
                }
            }
            return list;
        }
